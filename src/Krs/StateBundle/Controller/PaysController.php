...
use Krs\StateBundle\Entity\Pays;
use Krs\StateBundle\Form\PaysType;
...
class PaysController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KrsStateBundle:Pays')->findAll();
     ...
     * @Method("POST")
     * @Template("KrsStateBundle:Pays:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KrsStateBundle:Pays')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("KrsStateBundle:Pays:edit.html.twig")
     */
